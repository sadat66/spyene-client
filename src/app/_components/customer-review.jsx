        ...
        {Array(12)
          ...
          .map((el, i) => (
            <SwiperSlide key={i} className="h-[393px]">
              <div class="bg-[#1045AD] h-full relative text-white py-[53px] px-[32px] rounded-[8px_70px_8px_8px] border-red-900">
                <div
                  style={{
                    position: "absolute",
                    top: -2,
                ...
                <hr />
                <div className="h-full flex flex-col justify-between border">
